...
Разработать программный компонент (ROS-узел) построения локальной траектории движения из текущего положения робота в заданную точку пространства в обход препятствий. Целесообразно учитывать, что платформа имеет кинематические ограничения (минимальный радиус поворота равен 1.8м).

(Дополнительно) Задача поиска траектории выполняется в рамках прохождения заданного маршрута. В процессе движения по нему необходимо включать опрыскиватель через сегмент машрута и выключить по окончании движения.
